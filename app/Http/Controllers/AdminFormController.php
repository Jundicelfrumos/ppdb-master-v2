...
{
    public function adminformPendaftaran()
    {
        $provinsis = Provinsi::all();
        return view ('admin.form-admin', compact('provinsis'));
    }

    public function adminformPendaftaranPost(Request $request)
    {

            $formPendaftaran = new AdminFormPendaftaran();
